...
/// \date 2007/12/07
/// \author Peter Dodds
/// \brief CGM::Quaternion structure declaration
...
#ifndef _CGM_Quaternion_hpp_
#define _CGM_Quaternion_hpp_
...
#pragma pack(push,1)
  ...
  public:
    ...
    /// \returns CGM::Real - angle of rotation in radians
    Real GetAngle ();
    ...
    /// \returns CGM::Quaternion - conjugate of this quaternion
    Quaternion Conjugate () const;

    // -----------------------------------
    /// \brief Get the inverse of this quaternion
    /// \details This uses Conjugate()
    /// \returns CGM::Quaternion - 
